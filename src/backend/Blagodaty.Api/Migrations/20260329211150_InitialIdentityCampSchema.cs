...
{
    /// <inheritdoc />
    public partial class InitialIdentityCampSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChurchName = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChurchName = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: false),
                    PhoneNumber = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    EmergencyContactName = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: false),
                    EmergencyContactPhone = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    AccommodationPreference = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    HealthNotes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    AllergyNotes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
