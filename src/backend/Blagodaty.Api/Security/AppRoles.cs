...
public static class AppRoles
{
    ...
    [
        new(Member, "Участник", "Базовый доступ к личному кабинету, профилю и собственной заявке в лагерь."),
        new(CampManager, "Координатор лагеря", "Доступ к организаторским данным по поездке и работе с участниками."),
        new(Admin, "Администратор", "Полный доступ к системе, управлению ролями и административным разделам.")
    ];
