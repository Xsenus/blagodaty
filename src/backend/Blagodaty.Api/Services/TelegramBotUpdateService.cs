        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var result = command.Name switch
            {
                ...
                "event_stats" => await HandleEventStatsDetailedAsync(chat, message, command.Arguments, operatorUser, cancellationToken),
                "event_participants" => await HandleEventParticipantsDetailedAsync(chat, message, command.Arguments, operatorUser, cancellationToken),
                "event_registrations" => await HandleEventRegistrationsDetailedAsync(chat, message, command.Arguments, operatorUser, cancellationToken),
